...
class PositiveTests(unittest.TestCase):
    ...
    DESCRIPTION = u'Very strange. I need MORE description!\n' \
                  u'Are you serious?'
    PHOTO = 'http://uu.appsforall.ru/542ee0c9be4f73.01671974.jpg'
...
class NegativeTests(unittest.TestCase):
    ...
    ERROR_MSG = u"Невозможно опубликовать пустой текст"
    ...
    # Проверка необходимости заголовка
    def test_no_title(self):
        ...
        ask_form.set_subcategory(self.SUBCATEGORY)
        ask_form.submit()
        error_form = ask_form.get_error_form()

        self.assertEquals(error_form.get_title(), self.ERROR_TITLE)
        self.assertEqual(error_form.get_message(), self.ERROR_MSG)
